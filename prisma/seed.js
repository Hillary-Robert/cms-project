...
const seedQuestions = [
  ...
  },
  {
    ...
    date: "2026-03-22",
    answer:
      "A REST API is a system that uses HTTP methods like GET, POST, PUT, and DELETE to manage resources.",
    keywords: ["api", "http"],
  },
  {
    id: 3,
    ...
    date: "2026-03-25",
    answer:
      "Node.js allows JavaScript to run on the server using an event-driven, non-blocking architecture.",
  ...
  },
  {
    ...
    date: "2026-03-29",
    answer:
      "JSON is a format used to store and exchange data, often between a client and server.",
    keywords: ["json", "web"],
  },
  {
    id: 8,
